            ...
            {TYPES.map(({ key, icon: Icon }, i) => (
              <Reveal key={key} delay={i * 0.1} variant="zoom">
                ...
                <FresnelEdge className="h-full rounded-2xl">
                  <article className="group h-full overflow-hidden rounded-2xl border border-border bg-card p-8 transition-[border-color,box-shadow] duration-300 hover:border-primary/40 hover:card-lift-hover">
